...
In the  F<Game> folder, the programs  apply to the "Ace  of Aces" game
the  same  principles that  "Google  Alpha  Go  Zero" applied  to  Go:
self-learning the tricks of the trade.

The  older F<Jeu>  contains  programs  similar to  what  is in  folder
F<Game>, but  the coding standards  use French instead of  English and
the programs are not longer updated.
