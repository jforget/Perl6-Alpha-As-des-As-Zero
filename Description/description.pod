...
Années 1960 : on m'a raconté qu'IBM avait composé des
...
(I<First Person Shooters> en anglais), douze ans avant Wolfenstein 3D, treize ans
avant Doom..
...
=for html
<img src='voitures-0.png' width='30%' alt='Position de départ des deux voitures' />
...
=for html
<img src='voitures-1.png' width='30%' alt="Mini dans sa position de départ et VW dans sa position d'arrivée" />
...
=for html
<img src='voitures-2.png' width='30%' alt="Position d'arrivée des deux voitures" />
...
=for html
<img src='voitures-3.png' width='30%' alt="Position d'arrivée des deux voitures" />

I<Image personnelle. Les conditions de licence sont les mêmes que pour le texte.>

Deuxième étape de l'expérience. Les deux voitures se remettent dans la disposition correspondant
à la page 1. Puis c'est la Mini qui bouge la première pendant que la VW reste immobile.
On aboutit alors à la disposition de la page 48.

=for html
<img src='voitures-4.png' width='30%' alt="VW dans sa position de départ et Mini dans sa position d'arrivée" />
...
=for html
<img src='voitures-5.png' width='30%' alt="Position d'arrivée des deux voitures" />
...
options sort, limit et skip du find
