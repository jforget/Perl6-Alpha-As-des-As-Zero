...
Paragraphe 1. Vous entrez dans une auberge. Devant vous, vous voyez l'aubergiste à
...
image gros plan sur les flèches
...
ennemi, vous perdez 1, 2 ou 4 points de vie, selon la page. On ne tient pas
...
On dit que la mémoire à court terme d'un humain contient 7 ± 2 informations. À moins d'être
...
Pour rester dans la même optique que Google Alpha Go Zero et Google Alpha Chess Zera,
...
ce qui n'a pas donné de bons résultats. Il attribut des probabilités 
...
telle commande sur telle page de départ.

=head3 Communication inter-processus

Ainsi donc, il y a trois processus qui s'échangent des informations.
Ai-je eu recours à des sockets ? À des messages transmis par une queue ?
...
au bout d'un nombre important de tentatives, le processus considère qu'il s'est passé
...
rédigeais mon exposé. Je referai une nouvelle isntallation au moment où je
