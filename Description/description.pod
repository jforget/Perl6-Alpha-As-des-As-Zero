...
retrouver l'interprétation de chaque page sur la grille heagonale implicite.
...
associations manoœuvres → page d'arrivée de cette page de départ. Cela permet de
...
Ce livret est codé sous la forme d'un fichier JSON.
