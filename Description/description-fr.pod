...
L<Installation de Raku>, la version de xubuntu est toute récente, avec
par  conséquent un  paquet Perl6  et un  paquet Rakudo  assez récents,
puisqu'il  s'agit  de Perl  6.d.3  et  de  Rakudo 2020.12.  J'ai  donc
installé les paquets par Synaptic, je  n'ai pas cherché à compiler les
sources.

Si vous voulez compiler à partir  des sources, veuillez vous référer à
ce paragraphe L<Installation de Raku>.
...
L<https://github.com/zostay/HTTP-Supply/issues/5>)
...
passez  directement  au  L<paragraphe suivant|Installation  du  module
MongoDB>.
...
Puis effectuez quelques initialisation :
...
=head3 Programme C<site.p6> et programmes annexes

Le programme  C<site.p6> et ses programmes  annexes C<lib/site-xxx.p6>
...
programme C<lib/site-coup.p6>, les informations  affichées sont un peu
compliquées,  mais elles  reproduisent le  processus décisionnel  déjà
présenté dans le programme C<joueur.p6>.
