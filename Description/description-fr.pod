...
intermédiaire est la page 223, sur laquelle aucune manœuvre n'est indiquée.
...
=head3 Enchaînement des manœuvres
...
effectuées au  tour I<n> que  si l'avion  a effectué une  manœuvre
...
=item 7 le type de manœuvre (normale, tout droit, acrobatique, basse vitesse) si vous utilisez la règle sur les enchaînements de manœuvres,
...
des enchaînements entre  pages et manœuvres. Puis il y  a le L<jeu|"Jeu">
...
Tout d'abord, attribuez un code à chaque manœuvre. Pour I<Wingleader>,
...
Ainsi donc, les manœuvres du brevet sont les manœuvres B<A> et B<J>.
Ce qui nous donne :
...
la  vitesse :  I<slow> (lent)  pour  la manœuvre  B<A> et  I<cruising>
(vitesse de croisière) pour la manœuvre B<J>. Cela se traduit par :
...
de poursuite  (I<tailing>). Dans  notre cas,  les deux  manœuvres vont
...
page, la manœuvre B<A> nous renvoie  page 205 et la manœuvre B<J> nous
...
Notons que pour la page 187  du Camel, la manœuvre B<A> aurait conduit
à la page 198  et la manœuvre B<J> à la page 31.  Pour ces deux pages,
...
que le britannique a choisi une manœuvre vers la gauche. Les pages 1L / 1G,
1C / 1A et 1R / 1D ont exactement les  mêmes transitions manœuvre → page finale,
...
paragraphe L<Liste des manœuvres disponibles>, il se peut que l'option
