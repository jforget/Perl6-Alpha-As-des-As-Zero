...
L</"préparation">,  consistant  à  produire  les  livrets  sous  forme
électronique, en générant les fichiers plutôt qu'en tapant la totalité
des enchaînements entre  pages et manœuvres. Puis il y  a le L</"jeu">
...
Et en fait,  L<la fonctionnalité de Raku la  plus intéressante>, c'est
les points communs entre Perl et Raku. Une grande partie des lignes de
code dans un  programme Raku ressemblent à ce que  l'on écrit en Perl.
Dans les deux langages, on  utilise les accolades les points-vigrules,
les opérateur C<my> et C<sub>, etc.
...
L<les regex, anciennement expressions régulières>.
...
=head3 La fonctionnalité de Raku la plus intéressante

Cela  m'a   pris  très  longtemps   pour  me  rendre  compte   que  la
particularité la  plus intéressante  de Raku est  qu'il a  beaucoup de
