...
L<https://github.com/zostay/HTTP-Supply/issues/5>).  Pour  les  autres
modules, il  y a eu d'autres  erreurs que je  n'ai pas eu le  temps de
...
Il n'y a pas de conversion directe vers la classe C<Aircraf(> ou
...
I<à outrance> pour  les parties d'entraînement ait  introduit un biais
