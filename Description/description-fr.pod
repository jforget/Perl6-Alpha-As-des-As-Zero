...
la vitesse  : I<slow>  pour la  manœuvre B<A>  et I<cruising>  pour la
manœuvre B<J>. Cela se traduit par :
...
en  supposant  que  le fichier  s'appelle  F<Manfred-init.json>.  Puis
adaptez le  script F<launch>  pour permettre  le lancement  de parties
entre des pilotes connus.
