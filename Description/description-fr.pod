...
Le     programme    C<site.p6>     et    ses     programmes    annexes
C<lib/site->I<xxx>C<.p6>  sont  de  simples programmes  Bailador,  qui
décodent un URL,  en extraient une clé, lisent en  base de données des
informations en fonction de cette clé et affichent ces informations en
HTML. Dans  le cas du programme  C<lib/site-coup.p6>, les informations
affichées  sont  un  peu   compliquées,  mais  elles  reproduisent  le
processus décisionnel déjà présenté dans le programme C<joueur.p6>.
