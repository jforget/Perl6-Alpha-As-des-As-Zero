...
=for html
<img src='As-des-As-Wingleader-Jet-Eagles.jpg' alt="L'As des As,  Première Guerre Mondiale, Seconde Guerre Mondiale et Guerre Froide" width='45%' />
...
JSON comme une table d'associations page de départ + manœuvre → page d'arrivée.
