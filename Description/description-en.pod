...
with no line of Raku (even of Perl), but very useful for this project.
...
The  installation of  the  MongoDB  module for  Raku  was  a bit  more
...
I  find the  source file  in the  install directory  and I  remove the
debugging  statement.  The example  script  still  fails, because  the
bytecode file has not changed.
