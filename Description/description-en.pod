...
L<https://github.com/zostay/HTTP-Supply/issues/5>. Some  other modules
...
or right.  Both maneuvers are left  maneuvers, so we fill  the missing
values:
...
Note: from the  Camel's page 187, maneuver B<A> leads  to page 198 and
maneuver B<J> leads to page 31. The F<etape-finale.html> file gives:
