...
You should rather read the
L<Markdown  version|https://github.com/jforget/Perl6-Alpha-As-des-As-Zero/blob/master/Description/description-en.md>
of
the present text. In spring 2022,  I noticed that the rendering of POD
texts by Github was wrong  for paragraphs containing codepoints beyond
U+00FF. See for example the examples  of idiomatic code in the chapter
on L<The  Most Useful Feature  Of Raku>,  or the chapter  on L<Unicode
Operators> and compare them with their
L<Marldown|https://github.com/jforget/Perl6-Alpha-As-des-As-Zero/blob/master/Description/description-en.md#user-content-the-most-useful-feature-of-raku>
L<equivalents|https://github.com/jforget/Perl6-Alpha-As-des-As-Zero/blob/master/Description/description-en.md#user-content-unicode-operators>.
...
a few jokes which would puzzle the readers who do not share the same background
as me.
