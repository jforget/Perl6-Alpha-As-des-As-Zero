...
L</"Installation of  Rakudo"> below, the  xubuntu version I used  is a
very recent one and the Perl6 / Rakudo packages are rather up-to-date:
Perl  6.d.3 and  Rakudo  2020.12.  So I  installed  the packages  with
I<Synaptic>, I did not try to compile the sources.

If  you want  to compile  the  sources, see  the L</"Installationn  of
Rakudo"> paragraph.
