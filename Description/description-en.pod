...
L<xubuntu|https://xubuntu.fr/> 21.04  "Hirsute Hippo".  I do  not give
...
L<Installation> below, the xubuntu version I used is a very recent one
and the Perl6 / Rakudo packages  are rather up-to-date: Perl 6.d.3 and
Rakudo 2020.12.  So I installed  the packages with I<Synaptic>,  I did
not try to compile the sources.

If you want to compile the sources, see the L<Installation> paragraph.
...
you, install them and skip to the L<next paragraph|Installation of the
MongoDB Module>.
...
When you install MongoDB, you  should read the up-to-date instructions
...
I could have run a simpler command:
