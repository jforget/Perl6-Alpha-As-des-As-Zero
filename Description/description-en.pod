...
The documents are about two years apart and in the interim Perl 6 has been renamed
...
celebration window to a few months, it is also the hundredth anniversary of
Guynemer's passing and the 1918 armistice.
...
developed with Duoglas Kaufman. Instead of gathering two players around
the same game map and meking them push cardboard markers, each player has a booklet.
...
=for HTML
<img src='Page-1-GB-All.png' alt="Page 1 in both booklets" width='90%' />
