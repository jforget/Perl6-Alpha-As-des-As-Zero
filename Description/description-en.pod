...
The most helpful feature is actually the commonalities with Perl. Much
of what  you write  in Raku  is very  similar to  what you  would have
written  in   Perl:  curly  braces,  semi-colons,   C<my>  and  C<sub>
operators, etc.
...
writing basic Raku code is easy.
...
accents in the variable names and  the function names. I never dare do
this in Perl,  but in Raku is  has become customary. In  the same way,
you can use  the dash or hyphen inside an  identifiers where you would
