...
syntax or  some other  mainstream language syntax,  they create  a new
programming language with its specific  syntax, which the web designer
has to learn. Even  if the web designer is my own self,  I do not want
to learn yet another specific language with narrow use. HTML, Perl and
...
Also, I should  read again the three books that  taught me Raku. These
books contain may remarks that I missed  when I read the books for the
first time.  I did not remember  these remarks, because I  had not the
