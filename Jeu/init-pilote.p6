...
Ce programme recopie un fichier JSON décrivant un pilote dans la base MongoDB,
de façon à simplifier les programmes ultérieurs, qui n'ont plus besoin de lire du JSON.
