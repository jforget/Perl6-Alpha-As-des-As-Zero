...
L<après la première mise à jour|https://github.com/jforget/Perl6-Alpha-As-des-As-Zero/blob/master/Preparation/etape-1.pod>
...
À noter que l'affichage se fait en couleurs, mais que Github ne les reprend pas.
